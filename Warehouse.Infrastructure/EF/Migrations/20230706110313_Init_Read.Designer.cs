...
namespace Warehouse.Infrastructure.EF.Migrations
{
    ...
    [Migration("20230706110313_Init_Read")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Warehouse.Infrastructure.EF.Models.PackingItemReadModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Warehouse.Infrastructure.EF.Models.PackingListReadModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Warehouse.Infrastructure.EF.Models.PackingItemReadModel", b =>
                {
                    b.HasOne("Warehouse.Infrastructure.EF.Models.PackingListReadModel", "PackingList")
                        .WithMany("Items")
